...
![](media/15307210044415/cpp_virtual_function_base_b.png)
...
![](media/15307210044415/cpp_virtual_function_derived_bd.png)

上图并未列出在`Derived`定义的三个函数，查看`bd`处内存，

![](media/15307210044415/cpp_virtual_function_derived_bd_mem.png)
...
![](media/15307210044415/15307210754505.jpg)
